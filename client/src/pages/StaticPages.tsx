...
const PRIVACY_CONTENT = {
  ar: {
    ...
    intro: "تحترم بليار خصوصيتك وتلتزم بحماية بياناتك الشخصية وفقاً لأفضل الممارسات وقوانين دولة الكويت. توضح هذه السياسة كيفية جمعنا واستخدامنا وحمايتنا لمعلوماتك.",
...
const TERMS_CONTENT = {
  ar: {
    ...
    intro: "مرحباً بكم في موقع بليار. باستخدامك لهذا الموقع، فإنك توافق على الالتزام بهذه الشروط والأحكام. إن لم توافق عليها، يرجى عدم استخدام الموقع.",
    h1: "قبول الشروط",
    ...
    h6: "الملكية الفكرية",
    p6: "جميع محتويات الموقع (نصوص، صور، شعارات) محمية بحقوق النشر والعلامات التجارية. لا يجوز نسخها أو استخدامها تجارياً دون إذن مكتوب من بليار.",
    h7: "الاتصال",
