export const translations = {
  en: {
    ...
    home: {
      ...
      announcement: "Delivery: 3 KWD. Free delivery when you buy 2+ items. Selected areas: 5 KWD.",
  ...
  ar: {
    ...
    home: {
      ...
      announcement: "التوصيل: ٣ د.ك. توصيل مجاني عند شراء قطعتين أو أكثر. مناطق محددة: ٥ د.ك.",
