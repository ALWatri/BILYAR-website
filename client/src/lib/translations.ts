...
export const translations = {
  en: {
    ...
    static: {
      ...
      story_paragraphs: [
        "BILYAR is not just a brand. It is a statement born from intention, identity, and quiet power. It does not try to be loud, yet it is impossible to ignore. Rooted in elegance and elevated through purpose, BILYAR represents a woman who knows who she is — and chooses to express it with clarity, not compromise.",
        "The name itself carries weight. Inspired by the depth of emerald — rich, rare, and timeless — BILYAR was envisioned as more than fashion. It is a reflection of value. Not just material value, but inner worth. Every piece is designed to echo that philosophy: structured yet fluid, modest yet commanding, refined yet effortlessly wearable. The signature emerald and gold palette is not accidental; it symbolizes growth, prestige, and enduring beauty.",
        "BILYAR was created with a very specific woman in mind. She is not defined by trends. She is defined by presence. She walks into a room and does not need validation — her energy speaks first. She values quality over noise, intention over excess, and identity over imitation. Her wardrobe is not random; it is curated. And every piece she wears tells a story about her standards.",
        "Each design begins with purpose. The cuts are deliberate. The fabrics are selected not only for how they look, but for how they feel and move. The silhouettes are built to empower — to give structure without restriction, elegance without discomfort. Whether it is a long tailored blazer, a flowing dress, or a refined everyday piece, the goal is always the same: to make the wearer feel aligned, confident, and composed.",
        "But BILYAR does not stop at clothing. It extends into experience. From the moment a piece is received — wrapped in carefully designed packaging, accompanied by a message that speaks directly to the woman wearing it — the brand becomes personal. It is not just an order. It is a reminder: *you are seen, you are valued, and you deserve to feel good in what you wear.*",
        "BILYAR is also a foundation for expansion. It is a house of ideas, with sub-lines that reflect different expressions of the same identity. LUMÉ brings movement and energy into activewear. ORO introduces a softer, everyday elegance. Yet all remain connected by one core principle: **wear your value**.",
        "This is not fast fashion. This is not seasonal noise. This is a long-term vision — a brand that grows with its wearer, evolves with her life, and stays relevant not because it follows trends, but because it stands on something deeper.",
        "BILYAR is for the woman who does not ask, *“What should I wear?”* She asks, *“What represents me?”*",
  ...
  ar: {
    ...
    static: {
      ...
      story_title: "قصتنا",
      story_paragraphs: [
        "بِليار ليست مجرد علامة تجارية، بل هي موقف… فكرة وُلدت من نية واضحة وهوية راسخة وقوة هادئة. لا تسعى للضجيج، لكنها تُرى وتُشعر دون محاولة. تنبع من الأناقة، وتُصاغ بالمعنى، لتعكس امرأة تعرف من تكون — وتختار أن تعبّر عن نفسها بثقة، لا بتنازل.",
        "اسم \"بِليار\" يحمل في طيّاته عمقًا خاصًا، مستوحى من لون الزمرد؛ ذلك اللون الغني، النادر، والخالد. ومن هنا جاءت الرؤية: أن تكون العلامة أكثر من مجرد أزياء، بل انعكاسًا للقيمة — ليس فقط القيمة المادية، بل قيمة الذات. كل قطعة تُصمم لتعكس هذه الفلسفة: توازن بين الهيكلة والانسيابية، بين الاحتشام والحضور، بين الرقي والراحة. أما لوحة الألوان المميزة — الأخضر الزمردي والذهبي — فهي ترمز للنمو، والرفعة، والجمال المستمر.",
        "بِليار صُممت لامرأة محددة… امرأة لا تُعرّفها الصيحات، بل يعرّفها حضورها. تدخل المكان دون أن تطلب الانتباه، فطاقتها تسبقها. تختار الجودة بدل الضجيج، والنية بدل المبالغة، والهوية بدل التقليد. خزانتها ليست عشوائية، بل مدروسة بعناية، وكل قطعة فيها تحكي قصة معاييرها العالية.",
        "كل تصميم يبدأ بهدف. القصّات مدروسة، والأقمشة مختارة ليس فقط لمظهرها، بل لإحساسها وحركتها. التصاميم تُبنى لتمكين المرأة — تمنحها هيبة دون قيود، وأناقة دون تكلّف. سواء كانت القطعة بليزر طويلًا مفصلًا، أو فستانًا انسيابيًا، أو قطعة يومية راقية، فالهدف واحد: أن تشعر من ترتديها بالاتزان، والثقة، والسكينة.",
        "لكن بِليار لا تقف عند حدود الملابس، بل تمتد إلى التجربة. من لحظة استلام القطعة — مغلّفة بعناية، مرفقة برسالة تخاطب المرأة مباشرة — تتحول التجربة إلى شيء شخصي. ليست مجرد طلب، بل تذكير: *أنتِ مرئية، ذات قيمة، وتستحقين أن تشعري بالرضا عمّا ترتدينه.*",
        "بِليار أيضًا هي بداية لعالم أوسع. بيت من الأفكار، تتفرع منه خطوط تعكس جوانب مختلفة من نفس الهوية. \"LUMÉ\" تعبّر عن الحركة والطاقة في الملابس الرياضية، و\"Oro\" تقدّم أناقة يومية ناعمة. لكن جميعها يجتمع تحت مبدأ واحد: **ارتدي قيمتك**.",
        "هذه ليست موضة سريعة، ولا ضجيج موسمي. هذه رؤية طويلة المدى — علامة تنمو مع المرأة، وتتطور مع مراحل حياتها، وتبقى لأنها لا تتبع الصيحات، بل تستند إلى ما هو أعمق.",
        "بِليار ليست لمن تسأل: *ماذا أرتدي؟* بل لمن تسأل: *ما الذي يُمثّلني؟*",
